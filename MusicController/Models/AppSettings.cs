...
public record AppSettings
{
    public Dictionary<HotkeyAction, HotkeyBinding> Hotkeys { get; init; } = new()
    {
        ...
        { HotkeyAction.VolumeUp, new HotkeyBinding(ModifierKeys.Control | ModifierKeys.Alt, Key.Up) },
        { HotkeyAction.VolumeDown, new HotkeyBinding(ModifierKeys.Control | ModifierKeys.Alt, Key.Down) },
        { HotkeyAction.Mute, new HotkeyBinding(ModifierKeys.Control, Key.M) }
    };
